    ...
    <body class="w3-light-grey">
        ...
        <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
            ...
            <div class="w3-bar-block">
                ...
                <a href="#" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-eye fa-fw"></i> View borrow of students</a>
       ...
       <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class="w3-container w3-white">
                ...
                <table class="w3-table">
                    ...
                    <c:forEach items="${requestScope.borrows}" var="b">
                        <tr>
                            <td>${b.isbn}</td>
                            <td>${b.username}</td>
                            <td>${b.borrowDate}</td>
                ...
                <table class="w3-table">
                    ...
                    <c:forEach items="${requestScope.comments}" var="c">
                        <tr>
                            <td>${c.isbn}</td>
                            <td>${c.username}</td>
                            <td><i class="fa fa-star"></i> ${c.rate}</td>
                            <td>${c.comment}</td>
                            <td>${c.ratingDate}</td>
                        </tr>
                    </c:forEach>
