<%-- 
    Document   : StudentMainView
    Created on : Oct 18, 2017, 8:53:12 PM
    Author     : Nam
--%>
            ...
            <div>
                ...
                <div id="demo" class="w3-white">
                    ...
                    <c:if test="${requestScope.pageindex < requestScope.totalpage}">
                        ...
                        <input type="button" class="w3-button w3-dark-grey" onclick="paging(${requestScope.totalpage})" value="Last">
                    </c:if> 
                </div>
            </div>
